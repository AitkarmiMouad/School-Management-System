...
namespace School_Management_System
{
    public partial class StudentAccount : Form
    {
        ...
        private void LogOutBtn_Click(object sender, EventArgs e)
        {
            ...
            Application.OpenForms["StudentForm"].Hide();
            f.ShowDialog();
            Application.OpenForms["StudentForm"].Close();
        ...
        {
            DataTable dt = functions.ShowAccountInfo(connection, "Etudiant", " where ID_etudiant=" + parentUserID);
            Idtxtbx.Text = dt.Rows[0][0].ToString();
            FirstNametxtbx.Text = dt.Rows[0][1].ToString();
            LastNametxtbx.Text = dt.Rows[0][2].ToString();
            Emailtxtbx.Text = dt.Rows[0][3].ToString();
        ...
        private void label6_Click(object sender, EventArgs e)
        {
            ...
            if (password.Enabled == false)
            {
                ...
                try
                {
                    ...
                    SqlCommand insertCommand = new SqlCommand("update Etudiant set motdepasse=@motdepass where ID_etudiant=" + parentUserID, connection);
        ...
        private void label10_Click(object sender, EventArgs e)
        {
            ...
            if (phone.Enabled == false)
            {
                ...
                {
                    if (connection.State == ConnectionState.Closed) connection.Open();
                    SqlCommand insertCommand = new SqlCommand("update Etudiant set tel=@phone where ID_etudiant=" + parentUserID, connection);
