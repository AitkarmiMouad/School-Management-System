...
namespace School_Management_System
{
    public partial class TeacherAccount : Form
    {
        ...
        private void LogOutBtn_Click(object sender, EventArgs e)
        {
            ...
            Application.OpenForms["TeacherForm"].Hide();
            f.ShowDialog();
            Application.OpenForms["TeacherForm"].Close();
        ...
        {
            DataTable dt = functions.ShowAccountInfo(connection, "Prof", " where ID_prof=" + parentUserID);
            Idtxtbx.Text = dt.Rows[0][0].ToString();
            FirstNametxtbx.Text = dt.Rows[0][2].ToString();
            LastNametxtbx.Text = dt.Rows[0][1].ToString();
        ...
        private void label6_Click(object sender, EventArgs e)
        {
            ...
            if (password.Enabled == false)
            {
                ...
                try
                {
                    ...
                    SqlCommand insertCommand = new SqlCommand("update Prof set motdepasse=@motdepass where ID_prof=" + parentUserID, connection);
        ...
        private void label10_Click(object sender, EventArgs e)
        {
            ...
            if (phone.Enabled == false)
            {
                ...
                {
                    if (connection.State == ConnectionState.Closed) connection.Open();
                    SqlCommand insertCommand = new SqlCommand("update Prof set tel=@phone where ID_prof=" + parentUserID, connection);
